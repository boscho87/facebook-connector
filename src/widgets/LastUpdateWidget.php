...
class LastUpdateWidget extends Widget
{
    ...
    {
        return Craft::t('facebook-connector', 'LastUpdateWidget');
    }
    ...
    {
        return Craft::getAlias("@boscho87fbconn/facebookconnector/assetbundles/lastupdatewidgetwidget/dist/img/LastUpdateWidget-icon.svg");
    }
    ...
    public function getSettingsHtml()
    {
        return Craft::$app->getView()->renderTemplate(
            'facebook-connector/_components/widgets/LastUpdateWidget_settings',
            [
                'widget' => $this
            ]
        );
